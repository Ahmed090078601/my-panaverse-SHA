...
import outcome from '../../../../public/ProgramOutcome.jpg'
import Image from 'next/image'
const outcomePoints=["Product Ownership","Global Marketing by DAO", "Freelacing","Boosting Economy."]
